...
<title>CV - Souradeep Sarkar</title>
<!-- Favicon-->
...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Welcome To Souradeep Sarkar</a>
			<button
		...
		<div class="container">
			...
			<div class="text-center mt-4">
				<a class="btn btn-xl btn-outline-light"
					href=""> <i
					class="fas fa-download me-2"></i> CV Download!
				</a>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						56/29, B. B. Lane <br /> Howrah, 711106
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
				...
				<div class="col-lg-4">
					...
					<p class="lead mb-0">
						I created this web-page, So ask me before copying it. ^_^
					</p>
				</div>
			</div>
		</div>
	...
	<div class="copyright py-4 text-center text-white">
		<div class="container">
			<small>Copyright &copy; Souradeep Sarkar 2023</small>
		</div>
	</div>
	<!-- Portfolio Modals-->
	<!-- Portfolio Modal 1-->
